...
//reccuperer des informations du site ptwc
 function ptwc(longitude, lattitude) {	
	init_carte_empty(longitude, lattitude)
	console.log(longitude + " " + lattitude );
}
...
var greenIcon = new LeafIcon({
    iconUrl: 'https://cdn3.iconfinder.com/data/icons/basicolor-signs-warnings/24/181_warning_notice-128.png',
    //shadowUrl: 'http://leafletjs.com/examples/custom-icons/leaf-shadow.png'
})

//Affichage de la carte vide
function init_carte_empty(longitude, lattitude) {
	
		var point = new L.LatLng(longitude, lattitude);
		
		var map = L.map('mymap').setView([longitude, lattitude], 4);
		...
		*/
		...
		// var circle = L.circle([longitude, lattitude], 1500000, {
			// color: 'blue',
			// fillColor: 'blue',
			// fillOpacity: 0.2
		// }).addTo(map);
